...
class Programs extends MY_Controller {
    ...
    public function index($page = 0) {
        ...
        $total = $this->programs_model->getProgramsListAdmin($this->user->id, null, 0, $search_array, true);
        ...
        $data['items']  = $this->programs_model->getProgramsListAdmin($this->user->id, $per_page, $page, $search_array);
