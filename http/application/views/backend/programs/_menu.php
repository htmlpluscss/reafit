...
?>
<li><a class="icon-logout btn-to-list" href="<?php echo $list_url;?>"<?php echo (!$fullscreen) ? ' title="'.lang('program_to_list').'"' : '';?> data-action="<?php echo site_url('admin/programs');?>"></a></li>
