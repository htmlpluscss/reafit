	...
	<div class="popup popup--close">
		<div class="popup__box">
			<div class="popup__body">
				...
				<a class="btn btn--gray link-exit-redirect" href="<?php echo site_url('exercises');?>"><?php echo lang('dont_save');?></a>
				<a class="btn btn-save btn-save--redirect save-exit-redirect"><?php echo lang('save_change');?></a>
			</div>
			<a class="ico ico--close-white popup__close"></a>
		</div>
	</div>