...
class Exercises_model extends CI_Model {
    ...
    public function findExercises($users, $user = null, $params = array(), $tags = array(), $exclude = null, $deleted = false, $exclude_category = false) {
        if($users) {
            $this->db->select('e.*');
    ...
    public function getExercisesListTotal($user_id, $deleted = false, $params = array(), $category = false, $exclude_category = false) {
        if($user_id) {
    ...
    public function getExercisesList($user, $per_page = null, $page = 0, $deleted = false, $params = array(), $order = false, $category = false, $exclude_category = false) {
        if($user->id) {
            $this->db->select('*');
    ...
    public function getExercisesListAdmin($user = false, $per_page = null, $page = 0, $params = array(), $count = false, $author = false, $deleted = false, $category = false) {
        $this->db->select('e.*');
        $this->db->select('e.id AS related');
        $this->db->select('e.id AS progress');
        $this->db->select('e.id AS tags');
    ...
    public function getExercisesLast($user = false, $per_page = null, $page = 0, $order = array(), $count = false, $author = false, $deleted = false, $category = false, $exclude_category = false) {
        $this->db->select('e.*');
        $this->db->select('u.is_admin AS is_admin');
        if(!$deleted) {
            $this->db->where('e.deleted', 0);
