...
class Exercises extends MY_Controller {
	...
	public function index($page = 0) {
		...
		$total = $this->exercises_model->getExercisesListAdmin($this->user->id, null, 0, $search_array, true, false, false, $category);
		...
		$data['items']  = $this->exercises_model->getExercisesListAdmin($this->user->id, $per_page, $page, $search_array, false, false, false, $category);
