...
class User extends MY_Controller {
    ...
    public function registration() {
	    ...
	    $settings->status = str_replace("\r\n", "\n", $settings->status);
	    $data['statuses'] = explode("\n", $settings->status);
    ...
    public function profile() {
    	...
    	$statuses = $this->settings_model->getValue('status');
		...
		$data['params']      = json_decode($user_data->params);
