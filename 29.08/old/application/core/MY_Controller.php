...
class MY_Controller extends CI_Controller
{
    ...
    public function __construct() {
        ...
        $this->settings = $this->settings_model->getValues(array('site_name', 'forum_url', 'image_width', 'image_height', 'per_page', 'tinypng_key', 'categories'));
    ...
    public function ajaxResponse($data = array(), $error = false, $layout = 'frontend', $data_array = false) {
        $result = array();
    ...
    public function onlyAdmin($manager = true) {
        if(!$this->user || empty($this->user)) {
            $this->session->set_flashdata('error', lang('error_login_required'));
            redirect(base_url('login'));
