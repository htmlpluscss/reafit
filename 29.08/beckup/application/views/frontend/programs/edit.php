<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');?>
		...
		<div class="programme-head">
			...
			<a class="ico ico--fullscreen" title="<?php echo lang('fullscreen'); ?>"></a>
			<a class="ico ico--exit-app btn-to-list" href="<?php echo site_url('programs');?>" title="<?php echo lang('exit_app');?>" data-action="<?php echo site_url('programs');?>"></a>
		</div>
